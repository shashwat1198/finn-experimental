...
lstm_scan = make_graph(
    ...
    outputs = [out_hidden_state, out_cell_state, out_hidden_state_concat], #, out_input_out, out_ii,out_hi,out_input_acc, out_input_gate, out_if,out_hf,out_forget_acc, out_forget_gate, out_ic,out_hc,out_cell_acc, out_cell_gate, out_io,out_ho,out_out_acc, out_out_gate,out_first_input_out
    value_info=[
    ...
    initializer=[make_tensor('W_f',onnx.TensorProto.FLOAT, [20,10], (Wf_val)),
                 ...
                 make_tensor('inp_scale',onnx.TensorProto.FLOAT, [],[0.0078125]),
                 make_tensor('scale_i',onnx.TensorProto.FLOAT, [],[0.0017579200211912394]),
                 make_tensor('scale_c',onnx.TensorProto.FLOAT, [],[0.0017536403611302376]),
                 make_tensor('scale_o',onnx.TensorProto.FLOAT, [],[0.0017599976854398847]),
                 make_tensor('scale_f',onnx.TensorProto.FLOAT, [],[0.0017540532862767577]),
                 make_tensor('scale_1',onnx.TensorProto.FLOAT, [],[0.0078125]), #0.0057...
                 make_tensor('scale_2',onnx.TensorProto.FLOAT, [],[0.0078125]), #0034227842
                 make_tensor('scale_3',onnx.TensorProto.FLOAT, [],[0.0078125]),
                 make_tensor('scale_test',onnx.TensorProto.FLOAT, [],[0.0078125]),#Correct input scale : 0.00781916
                 make_tensor('scale_4',onnx.TensorProto.FLOAT, [],[0.0078125]),
                 make_tensor('scale_5',onnx.TensorProto.FLOAT, [],[0.0078125]),
                 make_tensor('scale_6',onnx.TensorProto.FLOAT, [],[0.0078125]),
                 make_tensor('scale_7',onnx.TensorProto.FLOAT, [],[0.003921568859368563]), #Approximate scale_7 value = 0.0085895785
#                  make_tensor('scale_7',onnx.TensorProto.FLOAT, [],[0]),
                 make_tensor('scale_8',onnx.TensorProto.FLOAT, [],[0.003921568859368563]),#0.0026683041
                 make_tensor('scale_9',onnx.TensorProto.FLOAT, [],[0.0078125]),
                 make_tensor('scale_10',onnx.TensorProto.FLOAT, [],[0.003921568859368563]),
                 make_tensor('scale_11',onnx.TensorProto.FLOAT, [],[0.0078125]),#0.0036052174
...
W_i = 0.0017579200211912394
U_i = 0.0017579200211912394
W_f = 0.0017540532862767577
U_f = 0.0017540532862767577
W_c = 0.0017536403611302376
U_c = 0.0017536403611302376
W_o = 0.0017599976854398847
