...
#     Nodes,
    ...
    value_info=[
            ...
            make_tensor_value_info("i_t_ba",onnx.TensorProto.FLOAT, [20,1]),# of the dequantized linear layer. Therefore float datatype as the input will now be processed differently.
            ...
            make_tensor_value_info("o_t_ba",onnx.TensorProto.FLOAT, [20,1]),#put of the dequantized linear layer. Therefore float datatype as the input will now be processed differently.
            ...
            make_tensor_value_info("out_el_mul2_e5",onnx.TensorProto.FLOAT, [20,1]),# of the dequantized linear layer. Therefore float datatype as the input will now be processed differently.
            make_tensor_value_info("out_tanh_e6",onnx.TensorProto.FLOAT, [20,1]),#tput of the dequantized linear layer. Therefore float datatype as the input will now be processed differently.
